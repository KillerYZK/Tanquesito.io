...
import { getDatabase, ref, set, onValue, onDisconnect, remove, update as fbUpdate, push } from "firebase/database";
...
export { ref, set, onValue, onDisconnect, remove, fbUpdate, push };